...
public class quiz02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		String brand = "로지텍";
		String name = "mx kyes";
		String price = "135,000";  // 가격 같은 경우는 숫자로 표현하는게 좋음 int 변수 
		...
		*/
		...
		String inch = "24"; // 숫자라서 int 변수도 가능
		String color = "black";
		boolean Hdmi = true;  // 가능여부 boolean 
		boolean playSound = false; // 가능여부 boolean 
		...
		*/
		...
		/* System.out.println (  한번에 덧셈 해도 됨 )
		...
		*/
		...
		// double num3 = (double)num1 / (double)num2  출력하면 System.out.println (num3) 0.4 나옴
